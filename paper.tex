...
%To assess the time interval over which this truncation is valid, we also solve the Finite State Projection \cite{Munsky2006} for the same truncation, which allows us to compute an upper bound on the truncation error as a function of time. 
...
\brian[Add section here describing the computer resources used and how long computations took for each type of analysis: What Matlab version and toolboxes, what cluster used (number/type of processors), OS,  ]
